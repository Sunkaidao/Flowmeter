...
//	added end
	...
	void Log_Write_Sprayer(AC_Sprayer &para_sprayer, uint32_t wp_dist, uint8_t para_fm_warn, uint8_t para_pk_cnt,uint16_t para_fm_vol, uint8_t para_fm_time, uint16_t view_flight_area);
#endif	
    ...
    void Log_Write_GuidedTarget(uint8_t target_type, const Vector3f& pos_target, const Vector3f& vel_target, uint8_t options);
